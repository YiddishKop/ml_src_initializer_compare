...
import cifar10_5conv_3fc_input
...
IMAGE_SIZE = cifar10_5conv_3fc_input.IMAGE_SIZE
NUM_CLASSES = cifar10_5conv_3fc_input.NUM_CLASSES
NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN = cifar10_5conv_3fc_input.NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN
NUM_EXAMPLES_PER_EPOCH_FOR_EVAL = cifar10_5conv_3fc_input.NUM_EXAMPLES_PER_EPOCH_FOR_EVAL
...
def distorted_inputs():
  ...
  return cifar10_5conv_3fc_input.distorted_inputs(data_dir=data_dir,
...
def inputs(eval_data):
  ...
  if not FLAGS.data_dir:
    raise ValueError('Please supply a data_dir')
  data_dir = os.path.join(FLAGS.data_dir, 'cifar-10-batches-bin')
  return cifar10_5conv_3fc_input.inputs(eval_data=eval_data, data_dir=data_dir,
                              batch_size=FLAGS.batch_size)
...
def inference(images):
  ...
  with tf.variable_scope('local7') as scope:
    weights = _variable_with_weight_decay('weights', shape=[500, 500],
                                          stddev=0.04, wd=0.004)
    biases = _variable_on_cpu('biases', [500], tf.constant_initializer(0.1))
  ...
  with tf.variable_scope('softmax_linear') as scope:
    ...
    softmax_linear = tf.add(tf.matmul(local8, weights), biases, name=scope.name)
